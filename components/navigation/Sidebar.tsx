...
export default function Sidebar() {
  ...
  return (
    <div className="relative h-screen flex">
      ...
      >
        <BsArrowLeftShort
          className={`bg-white text-dark-purple text-3xl duration-300 rounded-full absolute -right-3 top-8 border border-dark-purple cursor-pointer ${
            !open && "rotate-180"
          }`}
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                {/* Find another function for this inbox */}
              </Link>
            </li>
          </ul>
          <UserButton />
